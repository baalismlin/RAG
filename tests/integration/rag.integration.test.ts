...
describe("RAG Pipeline integration", () => {
  ...
  it("HybridRetriever merges and sorts by score", async () => {
    const docChunks: RetrievedChunk[] = [
      { chunk: { id: "d1", content: "Doc chunk", metadata: { source: "a.md", type: "markdown", chunkIndex: 0 } }, score: 0.7, storeType: "document" },
    ];
    const codeChunks: RetrievedChunk[] = [
      { chunk: { id: "c1", content: "Code chunk", metadata: { source: "b.ts", type: "code", language: "typescript", symbolType: "function", symbolName: "foo", filePath: "b.ts", startLine: 1, endLine: 5, chunkIndex: 0 } }, score: 0.9, storeType: "code" },
    ];
