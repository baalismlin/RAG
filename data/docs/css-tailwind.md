...
```html
<button class="bg-blue-500 hover:bg-blue-700 focus:ring-2 active:bg-blue-800">Interactive</button>

<input class="border-2 focus:border-blue-500 focus:outline-none" />

<div class="opacity-50 hover:opacity-100 transition-opacity">Fade on hover</div>
...
<body class="bg-white dark:bg-gray-900">
  <div class="text-gray-900 dark:text-white">Dark mode content</div>
</body>
```
    ...
    <div class="static fixed absolute relative sticky">
      <div class="top-0 right-0 bottom-0 left-0 inset-0">
        ...
        <div class="z-0 z-10 z-50 z-auto">
          <!-- Overflow -->
          <div class="overflow-auto overflow-hidden overflow-scroll overflow-clip"></div>
        </div>
      </div>
    </div>
  </div>
...
<div class="p-4 px-4 py-2 pt-4 pr-8 pb-2 pl-8">
  ...
  <div class="m-4 mx-auto my-8 mt-2 mb-4">
    ...
    <!-- Space between -->
    <div class="space-x-4 space-y-2"></div>
  </div>
</div>
```
...
<div class="w-full w-1/2 w-64 w-screen w-min w-max">
  ...
  <div class="h-full h-32 h-screen h-min h-max">
    <!-- Min/Max -->
    <div class="min-w-0 min-h-screen max-w-md max-h-full"></div>
  </div>
</div>
```
...
```html
<!-- Font -->
<p class="font-sans font-serif font-mono"></p>
...
<p class="leading-tight leading-relaxed leading-loose"></p>
<p class="tracking-tight tracking-wide tracking-wider"></p>
```
...
<div class="bg-white bg-gray-100 bg-blue-500">
  ...
  <div class="bg-cover bg-contain bg-no-repeat bg-center">
    ...
    <div class="bg-gradient-to-r from-blue-500 to-purple-600">
      <!-- Opacity -->
      <div class="bg-blue-500/50 bg-opacity-50"></div>
    </div>
  </div>
</div>
```
...
<div class="border border-2 border-4 border-0 border-t-2">
  ...
  <div class="border-gray-300 border-blue-500">
    ...
    <div class="rounded rounded-md rounded-lg rounded-full rounded-t-lg">
      <!-- Border style -->
      <div class="border-solid border-dashed border-dotted"></div>
    </div>
  </div>
</div>
```
...
<div class="shadow-sm shadow shadow-md shadow-lg shadow-xl shadow-2xl">
  ...
  <div class="opacity-0 opacity-50 opacity-100">
    ...
    <div class="blur-sm blur-md blur-lg blur-xl">
      ...
      <div class="transition duration-300 ease-in-out hover:scale-110"></div>
    </div>
  </div>
</div>
```
...
```html
<div class="w-[123px] h-[calc(100vh-4rem)] bg-[#1da1f2] text-[length:var(--font-size)]"></div>
```
...
```html
<p class="line-clamp-3">Text will be truncated after 3 lines...</p>
```
